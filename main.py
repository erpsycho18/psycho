...
from tgbot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from tgbot.modules import ALL_MODULES
from tgbot.modules.helper_functions.chat_status import is_user_admin
from tgbot.modules.helper_functions.misc import paginate_modules
...
It took lots of work for [my creator](t.me/dr_psycho_15) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
To paying him; contact him @dr_psycho_15."""
